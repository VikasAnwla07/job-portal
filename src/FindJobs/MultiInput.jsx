  ...
  return (
    <Combobox store={combobox} onOptionSubmit={handleValueSelect} withinPortal={false}>
      <Combobox.DropdownTarget>
        ...
        leftSection={
          <div className='text-bright-sun-400 bg-mine-shaft-900 p-1 mr-2 rounded-full'><props.icon/></div>
        }
        >
          <Pill.Group>
            {value.length > 0 ? (
              ...
              <Input.Placeholder className='!text-mine-shaft-200 text-center'>{props.title}</Input.Placeholder>
            )}
          </Pill.Group>
        </PillsInput>
      </Combobox.DropdownTarget>
