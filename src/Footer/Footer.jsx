...
const Footer = ()=>{
    ...
    return location.pathname!="/signup" && location.pathname!="/login" ? <div className="pt-20 pb-5 flex gap-5 justify-around bg-mine-shaft-950 font-['poppins']">
        ...
        <div className="flex gap-1 items-center text-bright-sun-400">
            ...
            <div className="flex gap-3 text-bright-sun-300 [&>div]:bg-mine-shaft-900 [&>div]:p-2 
        ...
        </div>
        {
            footerLinks.map((item,index)=> <div key={index}>
                <div className="text-lg font-semibold text-bright-sun-400 mb-3">{item.title}</div>
                {
                    ...
                    text-sm hover:text-bright-sun-400 cursor-pointer mb-1 hover:translate-x-2 transition
