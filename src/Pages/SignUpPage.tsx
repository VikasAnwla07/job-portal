...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-[90vh] bg-mine-shaft-950 font-['poppins'] relativeoverflow-hidden">
            <Button my="md" onClick={() => navigate("/")} className="!absolute left-5 z-10" color="bright-sun.4" leftSection={<IconArrowLeft size={20} />} variant="light">Home</Button>
